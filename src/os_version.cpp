...
#if defined(LINUX) && !defined(__x86_64__) && !defined(__arm__)
...
#elif defined( _WIN32 ) && !defined( _X360 ) && !defined( WIN64 )
...
CPUInformation DSL_CC GetCPUInformation() {
	CPUInformation ret;
	memset(&ret, 0, sizeof(ret));

	ret.bMMX = CheckMMXTechnology();
	ret.bSSE = CheckSSETechnology();
	ret.bSSE2 = CheckSSE2Technology();
	ret.b3DNow = Check3DNowTechnology();
